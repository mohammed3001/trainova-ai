    ...
    <footer className="mt-16 border-t border-slate-200 bg-white">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-4 py-8 sm:px-6 md:flex-row md:items-center md:justify-between lg:px-8">
        <div>
          ...
          <div className="text-xs text-slate-500">© {new Date().getFullYear()} Trainova AI. All rights reserved.</div>
        </div>
        <nav className="flex flex-wrap items-center gap-4 text-sm text-slate-600">
          <Link href={`/${locale}/about`} className="hover:text-brand-700">{t('about')}</Link>
