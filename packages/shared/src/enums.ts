...
export const AUDIT_ACTIONS = {
  ...
  // T9.E — KYC (individual identity verification)
  KYC_SESSION_STARTED: 'KYC_SESSION_STARTED',
  KYC_SESSION_SUBMITTED: 'KYC_SESSION_SUBMITTED',
  KYC_SESSION_APPROVED: 'KYC_SESSION_APPROVED',
  KYC_SESSION_REJECTED: 'KYC_SESSION_REJECTED',
  KYC_VERIFICATION_REVOKED: 'KYC_VERIFICATION_REVOKED',
} as const;
